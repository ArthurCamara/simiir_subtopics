...
STOPWORD_FILE_PATH = "/ssd2/arthur/simmir_py2/simiir/example_data/terms/stopwords.txt"
BACKGROUND_MODEL_FILE_PATH = "/ssd2/arthur/simmir_py2/simiir/example_data/terms/vocab.txt"

BING_KEY = "ad75f8f57d644d8bbc069fd0251d7c25"
...
def generate_simulation_files(all_combinations, expanded_entry, output_dir, experiment_base_dir, write=True):
    ...
    if write:
        ...
        mkdir_p(absolute_experiment_output_path)
