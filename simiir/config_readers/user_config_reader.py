...
class UserConfigReader(BaseConfigReader):
    """
    The User Configuration reader - checks for valid settings, and creates a series of components to represent the
        given configuration.
    """
    ...
    def _validate_config(self):
        """
        Validates the contents of the configuration file - under the assumption that it is well formed and conforms to
            the DTD.
        ...
        # Subtopic picker
        empty_string_check(self._config_dict["subtopicDecisionMaker"]["@class"])
        check_attributes(self._config_dict["subtopicDecisionMaker"])
