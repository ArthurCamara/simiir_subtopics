...
class TriTermQueryGenerator(BaseQueryGenerator):
    ...
    def __init__(self, stopword_file, background_file=[]):
        super(TriTermQueryGenerator, self).__init__(
            stopword_file, background_file=background_file)
    ...
    def generate_query_list(self, search_context):
        ...
        title_query_list = self.__get_title_combinations(
            topic_language_model, title_query_list)
        ...
        generated_permutations = self.__generate_permutations(
            topic_language_model, title_query_list, description_query_list)
