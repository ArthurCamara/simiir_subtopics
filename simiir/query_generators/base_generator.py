...
class BaseQueryGenerator(object):
    ...
    def _stem_term(self, term):
        """
        Applies the Porter stemming algorithm (implementation from the Whoosh IR toolkit) to a given term.
    ...
    def get_next_query(self, search_context):
        ...
        if search_context.query_limit > 0:
            ...
            # If this condition is met, no more queries may be issued.
            if number_queries == search_context.query_limit:
                return None
