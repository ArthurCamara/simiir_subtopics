...
class TopicBasedLMTextClassifier(LMTextClassifier):
    ...
    def make_topic_language_model(self):
        ...
        combined_term_counts = self._combine_dictionaries(
            combined_term_counts, background_terms, self.topic_background_weighting
        )
    ...
    def _update_topic_language_model(self, text_list):
        ...
        combined_term_counts = self._combine_dictionaries(
            combined_term_counts, background_scores, self.topic_background_weighting
        )
        combined_term_counts = self._combine_dictionaries(
            combined_term_counts, document_term_counts, self.document_weighting
        )
